Feature: Get_Contratos_ativos.feature
  ...
  Scenario Outline: Validar Contratos Ativos e inativo
    ...
    Given I use the route "/self-service/contract/v1/contracts/values?ip=54.76.98.192&document=<documento>"
    When I send the GET request
    Then I print the response
    Then I validate api fields

    Examples: 
      | Limit | Page | documento |
      |    10 |    1 | 000000802 |