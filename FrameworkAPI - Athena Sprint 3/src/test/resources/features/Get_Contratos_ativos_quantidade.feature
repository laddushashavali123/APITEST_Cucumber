Feature: Get_Contratos_ativos_quantidade.feature

  @scenario01
  Scenario Outline: Validar Contratos Ativos e inativo
    ...
    Given I use the route "/self-service/contract/v1/contracts/count?ip=54.76.98.192&document=<documento>&customerType=<customerType>"
    When I send the GET request
    Then I print the response
    Then I validate api quantidade de contratos ativos

    Examples: 
      | documento | customerType | Quantidadecontratos |
      | 000000802 |              |                  39 |
