Feature: HEADER_NOME.feature

  @scenario01
  Scenario Outline: ValidarAPI_HEADER_NOME
    ...
    Given I use the route "/self-service/authentication/v1/authenticationInfo"
    When I send the GET request
    Then I print the response
    Then Http response should be 200
    Then I validate api AuthenticationInfo "<logon>" "<expiration>"

    Examples: 
      | DocumentBase | Logon           | Expiration           |
      |     62173620 | ROBSON A SANTOS | 2019-05-29T18:49:00Z |
